...
import { AuthWrapCss, HeaderCss, ImgCss, InfoCss, UserCss, UserWrapCss } from './Header.styled';
      ...
      <HeaderCss>
        ...
        <AuthWrapCss>
          {isLogin ? (
            <UserWrapCss>
              <Link to="/user">
                {!avatar && <UserCss width="30" height="30" />}
                {avatar && <ImgCss src={avatar} alt='user' width="30" height="30" />}
              </Link>
